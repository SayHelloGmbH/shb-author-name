...
function Edit(_ref) {
  ...
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps)(extraProps),
        classNameBase = (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_3__.getBlockDefaultClassName)("shb/author-name");
  setAttributes({
    classNameBase
  });
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Author name", "shb-author-name")));
}
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)("shb/author-name", {
